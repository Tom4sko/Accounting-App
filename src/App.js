...
const App = () => {
  ...
  return (
    <div className="all-questions">
        <h1>Predkontácie</h1>
        <p>Táto stránka slúži ako opakovanie na maturitnú skúšku. Ak ma chceš podporiť <a href="https://ko-fi.com/tom4sko" target="_blanc" className="link">klikni sem.</a></p>
